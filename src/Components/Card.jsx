...
const Card = ({ thumbnail, title, channel, videoId, publish, mode }) => {
  return (
    <div>
      <Link to={videoId} style={{ textDecoration: "none", color: mode === 'white'?'white':"black" }}>
        <div className="card" style={{ border: mode === "white" ? "1px solid white" : "1px solid black",background: 'transparent' }}>
